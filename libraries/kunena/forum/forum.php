...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		if ('5.2.12' == '@' . 'kunenaversion' . '@')
		{
			...
			{
				self::$version = strtoupper('5.2.12');
			}
		}
		else
		{
		...
		self::$version_date  = ('2022-11-21' == '@' . 'kunenaversiondate' . '@') ? Factory::getDate()->format('Y-m-d') : '2022-11-21';
		self::$version_name  = ('Pessegueiro' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Pessegueiro';
	}
